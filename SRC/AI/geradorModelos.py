...
class Modelador:
    ...
    def carregar_modelo(caminho_modelo):
        """
        Carrega um modelo treinado a partir do caminho especificado (formato .h5).
        
        Args:
            caminho_modelo (str): Caminho para o arquivo do modelo (.h5)
